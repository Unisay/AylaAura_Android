...
public class RobTestConstants {
    ...
    // Login credentials
    public static final String TEST_USERNAME = "aminoneplus@gmail.com"; //"gene+1@aylanetworks.com";
    ...
    public static final String TEST_DEVICE_DSN = "AC000W000069367"; //"AC000W000069322"; //""AC000W000069456";
    public static final String TEST_DEVICE_SSID = "Ayla-4439c47ff8a8";
    ...
    public static final String TEST_USERNAME2 = "aylatestfest@gmail.com"; //"gene+3@aylanetworks.com";
    ...
    //Registration constants. Make sure you change them to valid DSN's that exists in RobCacheTest.java Cloud
    public static final String TEST_REGISTER_SAME_LAN_DSN = "AC000W000069322";
    ...
    public static int API_TIMEOUT_MS = 10000; //10000;
     ...
     */
    public static AylaAuthorization signIn(Context context) {
        // Initialize the library
        AylaSystemSettings systemSettings =
                new AylaSystemSettings(RobTestConstants.US_DEVICE_DEV_SYSTEM_SETTINGS);

        // We need to set our context
        systemSettings.context = context;
        //systemSettings.mockTest = true;
        ...
        UsernameAuthProvider authProvider = new UsernameAuthProvider(RobTestConstants.TEST_USERNAME,
                RobTestConstants.TEST_PASSWORD);

        loginManager.signIn(authProvider, TEST_SESSION_NAME, future, future);
        AylaAuthorization auth = null;

        try {
            auth = future.get(RobTestConstants.API_TIMEOUT_MS, TimeUnit.MILLISECONDS);
        ...
        public boolean waitForInitComplete() {
            try {
                ...
                synchronized (_initCompleteSemaphore) {
                    ...
                    _initCompleteSemaphore.wait(RobTestConstants.API_TIMEOUT_MS); // * 3);
                }
            } catch (InterruptedException e) {
