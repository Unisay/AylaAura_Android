...
public class RobTestConfig {
     ...
     */
    public AylaAuthorization signIn(RobTestAccountConfig testAccount, Context context) {
        // Initialize the library

        InstrumentationTestCase.assertNotNull(context);
        testSystemSettings.context = context;
        //testSystemSettings.mockTest = true;
        ...
        InstrumentationTestCase.assertNotNull("Authorization has no access token",
                auth.getAccessToken());
        InstrumentationTestCase.assertNotNull("Authorization has no refresh token",
    ...
    public boolean waitForDeviceManagerInitComplete(String sessionName) {
        ...
        InstrumentationTestCase.assertNotNull("No session manager was created after login",
                sessionManager);

        AylaDeviceManager deviceManager = sessionManager.getDeviceManager();
        InstrumentationTestCase.assertNotNull("No device manager was created after login",
                deviceManager);
    ...
    public static class InitCompleteWaiter implements AylaDeviceManager.DeviceManagerListener {
        ...
        public boolean waitForInitComplete() {
            try {
                ...
                InstrumentationTestCase.fail("Failed to get deviceListChanged call from " +
                        "DeviceManager");
                return false;
            }
            return _error == null;
    ...
    public static class InitDSSWaiter implements AylaDSManager.DSManagerListener{
        ...
        public boolean waitForConnectionChange() {
            try {
                ...
                InstrumentationTestCase.fail("Failed to get dss start call from " +
                        "sessionManager");
                return false;
            }
            return true;
