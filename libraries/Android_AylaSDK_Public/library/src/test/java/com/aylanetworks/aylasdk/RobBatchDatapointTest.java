...
public class RobBatchDatapointTest {
    ...
    public void setUp() {
        ...
        _deviceManager = AylaNetworks.sharedInstance()
                ...
                .getDeviceManager();
        _device = _deviceManager.deviceWithDSN(RobTestConstants.TEST_DEVICE_DSN);
    ...
    public void testCreateDataPoints() {
        ...
        AylaProperty<String> cmdProperty = _device.getProperty(RobTestConstants.TEST_DEVICE_PROPERTY_STRING);
        assertNotNull(cmdProperty);
        AylaProperty<Float> decimalProperty = _device.getProperty(RobTestConstants.TEST_DEVICE_PROPERTY_DECIMAL);
        assertNotNull(decimalProperty);
        AylaProperty<Integer> intProperty = _device.getProperty(RobTestConstants.TEST_DEVICE_PROPERTY_INT);
        ...
        Float oldDecimalvalue = decimalProperty.getValue();
        Float newDecimalValue = oldDecimalvalue + 1;

        int oldIntvalue = intProperty.getValue();
