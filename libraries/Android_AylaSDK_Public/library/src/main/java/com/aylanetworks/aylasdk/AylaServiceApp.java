...
public class AylaServiceApp {
    ...
    /**
     * Configures the receiver as AylaNotificationType for Google Push
     *
     * @param registrationId The registration ID needed for GCM
     * @param message        The Push message for GCM
     ...
     */
    public void configureAsPushAndroid(String registrationId, String message,String pushSound,
                                       String pushMetaData) {
        this.registrationId = registrationId;
        this.message = message;
        this.pushSound = pushSound;
        this.pushMdata = pushMetaData;
        _notificationType = NotificationType.GooglePush;
    }
