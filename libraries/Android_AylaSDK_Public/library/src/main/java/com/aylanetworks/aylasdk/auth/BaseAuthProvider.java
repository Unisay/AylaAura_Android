...
public abstract class BaseAuthProvider implements AylaAuthProvider {
    ...
    public AylaAPIRequest updateUserProfile(AylaSessionManager sessionmanager, AylaUser user,
        ...
        try {
            ...
            userJson.put("application", application);
        ...
        AylaAPIRequest<AylaUser> request = new AylaJsonRequest<AylaUser>(Request.Method.PUT,
                url, bodyJson, null, AylaUser.class, sessionmanager, successListener,
                errorListener);
