 ...
 */
public class AylaDSManager implements WebSocket.WebSocketConnectionObserver,
     ...
     */
    private void connectToSocket(String stream_key){
        ...
        if (getDeviceManager().getState()!= DeviceManagerState.Paused) {
            ...
            try {
                ...
                _aylaWebSocketConn.connect(websocketURI, this);
            } catch (URISyntaxException | WebSocketException e) {
                Log.d(LOG_TAG, "Exception in connectToSocket() "+e.getMessage());
                onClose(WebSocketCloseNotification.INTERNAL_ERROR, "exception "+e);
            }
        }
    }
    ...
    public void onTextMessage(String payload) {
        ...
        if(payload != null){
            ...
            if(payload.equals(HEARTBEAT)){
                _aylaWebSocketConn.sendTextMessage(payload);
                ...
                if(startIndex != -1 ){
                    ...
                    AylaDataStream dataStream = gson.fromJson(dsMessage, AylaDataStream.class);
                ...
                createSubscription(DS_NAME, DS_DESCRIPTION, null,
                        new Listener<AylaDSSubscription>() {
                            ...
                            Log.e(LOG_TAG, "Error in createSubscription. Start retry create " +
                                ...
                                // Do not retry if device list is empty
