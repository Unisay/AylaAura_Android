...
public class AylaDeviceNode extends AylaDevice {
    ...
    public AylaDeviceGateway getGateway() {
        ...
        List<AylaDevice> devices = dm.getDevices(new Predicate<AylaDevice>() {
            @Override
     ...
     * @param ackTimeout Timeout, in seconds, to wait for acknowledgement of the datapoint
    ...
    <T> CreateDatapointCommand<T> getCreateDatapointCommand(AylaProperty<T> property, T value,
                                                         Map<String, String> metadata, int
                                                                 ackTimeout) {
        return new CreateDatapointCommand<>(property, value, metadata, getDsn(), ackTimeout);
    }
    ...
    public void updateConnectionStatus(boolean isConnected) {
        ...
        if (shouldNotify) {
            notifyDeviceChanged(new FieldChange("connectionStatus"));
        }
    }
