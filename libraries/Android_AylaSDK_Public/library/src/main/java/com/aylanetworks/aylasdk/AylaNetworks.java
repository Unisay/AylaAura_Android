...
public class AylaNetworks {
    private static final String SDK_VERSION = "5.6.02";
    private static final String SDK_SUPPORT_EMAIL = "mobile-libraries@aylanetworks.com";
    /**
    ...
    public String getServiceUrl(ServiceUrls.CloudService cloudService, @Nullable String path) {
        String url = ServiceUrls.getBaseServiceURL(cloudService,
     ...
     */
    public static final String PLUGIN_ID_DEVICE_LIST = "com.aylanetworks.aylasdk.devicelist";
