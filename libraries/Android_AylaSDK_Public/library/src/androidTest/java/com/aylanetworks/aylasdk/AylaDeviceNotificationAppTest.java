...
public class AylaDeviceNotificationAppTest extends InstrumentationTestCase {
    ...
    public void testCreateUpdatePushDeviceNotificationApp() {
        ...
        notificationApp.configureAsPushAndroid(registrationId, message, pushSound, pushMData);
        //setting nickname is optional
        notificationApp.setNickname(nickName);
        ...
        _deviceNotificationApp.configureAsPushAndroid(registrationId, message, updatedPushSound,
                updatedPushMdata);
