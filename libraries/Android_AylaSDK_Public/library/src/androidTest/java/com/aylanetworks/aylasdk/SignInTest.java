...
public class SignInTest extends InstrumentationTestCase {
    ...
    public void setUp() throws Exception {
        ...
        systemSettings.context = getInstrumentation().getContext();
    ...
    public void testCachedAuthProvider() {
        ...
        CachedAuthProvider.cacheAuthorization(getInstrumentation().getContext(), auth);

        cachedAuthProvider = CachedAuthProvider.getCachedProvider(getInstrumentation().getContext());
