...
public class DatapointBlobTest extends InstrumentationTestCase {
    AylaDevice _device;
    ...
    public void setUp() {
        ...
        String path = Environment.getExternalStorageDirectory().toString() + "/DatapointBlobTest";
    ...
    public void testUploadDatapointBlob() {
        ...
        _localOutputfilePath = path + "/blobOutTest.txt";
